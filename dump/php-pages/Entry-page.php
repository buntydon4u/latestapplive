...
function enableJantriInputs() {
    ...
    <script>
        const DEFAULT_ACTION =  "https://new.bull99exch.com/tbl_transactions/add_transaction_final_app";

        const JANTRI_ACTION =   "https://new.bull99exch.com/tbl_jantri/add_jantri_form_app";
    </script>
    <script>
